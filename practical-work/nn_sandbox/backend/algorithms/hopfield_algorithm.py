...
from . import StateAlgorithm
from ..neurons import Perceptron
from ..utils import sigmoid, bi_sigmoid


class HopfieldAlgorithm(StateAlgorithm):
    """ Backpropagation prototype. """

    def __init__(self, dataset, total_epoches=10,initial_learning_rate=0.8,momentum_weight=0.5, test_ratio=0.3, network_shape=None, mode_name='DHNN', train_mode='异步更新'):
        super().__init__(dataset, total_epoches, initial_learning_rate, test_ratio)

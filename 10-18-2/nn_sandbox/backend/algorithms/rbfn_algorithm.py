...
class RbfnAlgorithm(PredictiveAlgorithm):
    def __init__(self, dataset, total_epoches=5000, most_correct_rate=None,
                 acceptable_range=0.9, initial_learning_rate=0.01,
                 search_iteration_constant=10000, cluster_count=10,
                 test_ratio=0.3):
